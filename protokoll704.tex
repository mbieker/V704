...
\]
gemesse. Die Ergebnisse, sowie die dauraus berechnete Zählrate
\[
A = \frac{N}{\Delta t}
\]
befinden sich in Tabelle \ref{tab_beta}. In Abbildung \ref{abb_beta} werden diese Daten halblograrithmisch aufgetragen. Es zeigt sich der zu erwartende Kurvenverlauf. Eine lineare Augleichsrechnung
\[
y=m x +b
\]
...
Aus diesem Wert kann mit Hilfe der empirschen Formel (\ref{})
\section{Diskussion}
